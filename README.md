...
**Анализ пользовательского поведения в мобильном приложении, оценка результатов А/А/В теста**
...
## Проект 9: Bank Clients Analysis, Segmentation By Consuming
...
## Проект 10: Analysis Of Correctness And Results Of AB-test
...
Задачи проекта: Оценить корректность проведения A/B-теста и провести оценку его результатов.

## Проект 11: Database Analysis For Book Reading Service
...
Задачи проекта: Проанализировать базу данных крупного сервиса для чтения книг по подписке.
